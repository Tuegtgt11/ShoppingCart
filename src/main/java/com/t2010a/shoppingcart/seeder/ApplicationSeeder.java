package com.t2010a.shoppingcart.seeder;
...
import com.t2010a.shoppingcart.repository.OrderDetailRepository;
...
public class ApplicationSeeder implements CommandLineRunner {
    ...
    int numberOfOrder = 300;

    public ApplicationSeeder(OrderRepository orderRepository, OrderDetailRepository orderDetailRepository, ProductRepository productRepository) {
